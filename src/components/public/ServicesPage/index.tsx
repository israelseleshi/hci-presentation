...
import { FiUserCheck, FiUsers, FiLock, FiUserPlus, FiSearch, FiMessageSquare, FiShield } from 'react-icons/fi';
      ...
      <div className="bg-primary-gradient d-flex align-items-center" style={{ minHeight: 'calc(100vh - 72px)' }}>
        <div className="container text-white py-5">
          <div className="text-center mb-5">
            ...
            <p className="lead">Learn more about what we offer.</p>
          </div>
          <div className="row">
            <div className="col-md-4 mb-4">
              <div className="card h-100 text-center p-4 shadow-sm bg-transparent border-light">
                <div className="card-body">
                  <FiUserCheck size={40} className="mb-3" />
                  <h4 className="fw-bold text-white">For Clients</h4>
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100 text-center p-4 shadow-sm bg-transparent border-light">
                <div className="card-body">
                  ...
                  <h4 className="fw-bold text-white">For Freelancers</h4>
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100 text-center p-4 shadow-sm bg-transparent border-light">
                <div className="card-body">
                  ...
                  <h4 className="fw-bold text-white">Secure Payments</h4>
          ...
          <div className="row text-center">
            ...
            <div className="col-md-3 mb-4">
                ...
                <h5 className="text-white">3. Collaborate</h5>
            ...
            <div className="col-md-3 mb-4">
                ...
                <h5 className="text-white">4. Payment Protection</h5>
