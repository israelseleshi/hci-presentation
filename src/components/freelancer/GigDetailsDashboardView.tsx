...
const GigDetailsDashboardView: React.FC = () => {
  ...
  return (
    <div className="px-md-4">
      <button className="btn btn-outline-secondary mb-3" onClick={() => navigate(-1)}>Back to Find Work</button>
      <div className="card shadow-sm border-light-subtle">
        <div className="card-body p-4">
          ...
          <button className="btn btn-primary" onClick={() => navigate(`/freelancer/dashboard/apply/${gig.id}`)}>Apply for this Gig</button>
        </div>
      </div>
    </div>
  );
...
export default GigDetailsDashboardView;
